          ...
          <tbody>
            <template v-if="types.length >= 1">
              <tr v-for="(type, i) in types" :key="type.name">
                ...
                <td class="text-end">
                  <TheButton data-bs-toggle="modal" data-bs-target=".editingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" color="success" @click="selectedTypeData = type">
                ...
                <TheButton data-bs-toggle="modal" data-bs-target=".deletingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" color="warning" @click="selectedTypeData = type">
            ...
            <tr v-else>
              <td colspan="3" class="text-center">
                <span class="text-danger">Type not found!</span>
              </td>
            </tr>
          </tbody>
          <!--end::Table body-->
