    ...
    <div class="card-body py-3">
      ...
      <div class="table-responsive" v-else>
        ...
        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
          ...
          <!--begin::Table body-->
          <tbody>
            <template v-if="powers.length >= 1">
              <tr v-for="(power, i) in powers" :key="power.name">
                <td>{{ i+1 }}</td>
                <td>
                  <div class="d-flex align-items-center">
                    <div class="d-flex justify-content-start flex-column">
                      <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ power.name }}</a>
                    </div>
                  </div>
                </td>
                <td class="text-end">
                  <TheButton data-bs-toggle="modal" data-bs-target=".editingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" color="success" @click="selectedPowerData = power">
                ...
                <TheButton data-bs-toggle="modal" data-bs-target=".deletingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" color="warning" @click="selectedPowerData = power">
            ...
            <tr v-else>
              <td colspan="3" class="text-center">
                <span class="text-danger">Power not found!</span>
              </td>
            </tr>
          </tbody>
          <!--end::Table body-->
