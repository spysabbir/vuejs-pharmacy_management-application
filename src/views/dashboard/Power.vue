...
const selectedPowerId = (id) => {
  selectedPowerData.value = powers.value.find((power) => power.id === id);
};
</script>
  ...
  <div class="card mb-5 mb-xl-8">
    ...
    <div class="card-body py-3">
      ...
      <div v-else>
        ...
        <EasyDataTable buttons-pagination border-cell alternating show-index header-text-direction="center" body-text-direction="center" :headers="headers" :items="powers" :rows-per-page="10" :search-field="searchField" :search-value="searchValue">
          <template #item-action="{ id }">
            <TheButton data-bs-toggle="modal" data-bs-target=".editingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" color="success" @click="selectedPowerId(id)">
            ...
            <TheButton data-bs-toggle="modal" data-bs-target=".deletingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" color="warning" @click="selectedPowerId(id)">
