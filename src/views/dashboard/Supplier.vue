    ...
    <div class="card-body py-3">
      ...
      <div class="table-responsive" v-else>
        ...
        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
          ...
          <!--begin::Table body-->
          <tbody>
            <template v-if="suppliers.length >= 1">
              <tr v-for="(supplier, i) in suppliers" :key="supplier.name">
                ...
                <td class="text-end">
                  <TheButton data-bs-toggle="modal" data-bs-target=".editingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" color="success" @click="selectedSupplierData = supplier">
                ...
                <TheButton data-bs-toggle="modal" data-bs-target=".deletingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" color="warning" @click="selectedSupplierData = supplier">
            ...
            <tr v-else>
              <td colspan="4" class="text-center">
                <span class="text-danger">Supplier not found!</span>
              </td>
            </tr>
          </tbody>
          <!--end::Table body-->
