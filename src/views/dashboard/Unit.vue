...
const searchField = ["unit_name", "piece_in_unit"];
const searchValue = ref();

const headers = [
  { text: "Unit Name", value: "unit_name" },
  { text: "Piece in Unit", value: "piece_in_unit" },
  { text: "Created At", value: "created_at", sortable: true },
  { text: "Action", value: "action" },
];

const selectedUnitId = (id) => {
  selectedUnitData.value = units.value.find((unit) => unit.id === id);
};
</script>
  ...
  <div class="card mb-5 mb-xl-8">
    ...
    <div class="card-body py-3">
      ...
      <div v-else>
        ...
        <EasyDataTable buttons-pagination border-cell alternating show-index header-text-direction="center" body-text-direction="center" :headers="headers" :items="units" :rows-per-page="10" :search-field="searchField" :search-value="searchValue">
          <template #item-action="{ id }">
            <TheButton data-bs-toggle="modal" data-bs-target=".editingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" color="success" @click="selectedUnitId(id)">
            ...
            <TheButton data-bs-toggle="modal" data-bs-target=".deletingModel" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" color="warning" @click="selectedUnitId(id)">
