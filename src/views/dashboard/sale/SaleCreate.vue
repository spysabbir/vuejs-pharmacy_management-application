                ...
                <table class="table align-middle text-center">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="number" v-model="sales_quantity" @input="addToCartQty(sales_quantity)" ref="sales_quantity"></td>
                      <td>
              ...
              <table class="table table-striped table-hover align-middle text-center">
                ...
                <tbody>
                  <tr v-for="(cartItem, i) in saleCartData" :key="cartItem.id">
                    ...
                    <td>
                      <input type="number" v-model="cartItem.sales_quantity" @input="validateCartQuantity(cartItem)">
    ...
    methods: {
      ...
      addToCart(selectedMedicine) {
        if(!this.sales_quantity){
          ...
          this.addToCartItem({ ...selectedMedicine, sales_quantity: this.sales_quantity });
