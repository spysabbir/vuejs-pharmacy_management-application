            ...
            <table class="table table-striped table-hover align-middle text-center">
              ...
              <tbody>
                <tr v-for="item in sale.items" :key="item.medicine.id">
                  ...
                  <td>{{ authStore.defaultSettings.app_currency_symbol }} {{ item.medicine.sales_price }}</td>
                  <td>
                    <input type="number" v-model="item.sales_quantity" @change="sale.updateQuantity(item.medicine.id, item.sales_quantity)">
                  </td>
                  <td>{{ authStore.defaultSettings.app_currency_symbol }} {{ item.medicine.sales_price * item.sales_quantity }}</td>
                  <td>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle text-center">
              <thead class="table-info">
                <tr>
                  <th>Sub Total:</th>
                  <th>{{ authStore.defaultSettings.app_currency_symbol }} {{ sale.subTotalPrice }}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
