  ...
  <div class="purchase-invoice" ref="invoiceRef">
    ...
    <div class="details">
      <div class="detail">
        ...
        <span class="value">{{ purchaseInvoice.purchases_invoice_no }}</span>
      </div>
      <div class="detail">
        <span class="label">Supplier:</span>
        <span class="value">{{ purchaseInvoice.supplier_name }}</span>
      </div>
      <div class="detail">
        <span class="label">Date:</span>
        <span class="value">{{ purchaseInvoice.created_at }}</span>
      </div>
    </div>
    <div class="items">
...
const printInvoice = () => {
  ...
  printWindow.document.write('<style>@media print{body{margin: 0;padding: 0;}.purchase-invoice *{font-family: Arial, sans-serif;}.actions{display: none;}}</style>');
