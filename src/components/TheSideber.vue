      ...
      <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
        ...
        <div class="menu-item">
          <div class="menu-content pt-8 pb-2">
            <span class="menu-section text-muted text-uppercase fs-8 ls-1">Purchase</span>
          </div>
        </div>
        <div class="menu-item">
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion" :class="{ 'show': this.$route.path === '/dashboard/purchase/create' || this.$route.path === '/dashboard/purchase/list' }">
          ...
          <div class="menu-sub menu-sub-accordion menu-active-bg" :class="{ 'show': this.$route.path === '/dashboard/purchase/create' || this.$route.path === '/dashboard/purchase/list' }">
            <div class="menu-item">
              <RouterLink class="menu-link" to="/dashboard/purchase/create" :class="{ 'active': this.$route.path === '/dashboard/purchase/create' }">
        ...
        <div class="menu-item">
          <div class="menu-content pt-8 pb-2">
            <span class="menu-section text-muted text-uppercase fs-8 ls-1">Sale</span>
          </div>
        </div>
        <div class="menu-item">
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion" :class="{ 'show': this.$route.path === '/dashboard/sale/create' || this.$route.path === '/dashboard/sale/list' }">
          ...
          <div class="menu-sub menu-sub-accordion menu-active-bg" :class="{ 'show': this.$route.path === '/dashboard/sale/create' || this.$route.path === '/dashboard/sale/list' }">
            ...
            <div class="menu-item">
              <RouterLink class="menu-link" to="/dashboard/sale/list" :class="{ 'active': this.$route.path === '/dashboard/sale/list' }">
                <span class="menu-bullet">
                  <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">List</span>
